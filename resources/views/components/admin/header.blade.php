    ...
    <ul class="app-nav">
        ...
        <li class="dropdown"><a class="app-nav__item" href="#" data-toggle="dropdown"
            ...
            <ul class="dropdown-menu settings-menu dropdown-menu-right">
                <li><a class="dropdown-item" href="{{url('admin/setting')}}"><i class="fa fa-cog fa-lg"></i> Settings</a>
                </li>
                <li><a class="dropdown-item" href="{{ route('profile.edit') }}"><i class="fa fa-user fa-lg"></i>
                        Profile</a>
                </li>
                <li><a class="dropdown-item" href="{{ route('profile.destroy') }}"><i class="fa fa-sign-out fa-lg"></i>
                        Logout</a></li>
            </ul>
        </li>
    </ul>
