                     ...
                     <div class="header__top__right">
                         <div class="header__top__links">
                             ...
                             @if (isset($nameSession))
                                 ...
                                 <a href="{{ url('logout') }}">logout</a><span class="arrow_carrot-down"></span>
                             @else
                                 <a href="{{ route('customlogin') }}">Sign in</a>
         ...
         <div class="row">
             <div class="col-lg-3 col-md-3">
                 <div class="header__logo">
                     <a href="{{ url('/') }}"><img src="{{ asset('storage/setting/' . setting()->hedingImg) }}"
                             alt=""></a>
                 </div>
             </div>
             ...
             <div class="col-lg-3 col-md-3">
                 <div class="header__nav__option">
                     <a href="#" class="search-switch"><img src="{{ asset('front/img/icon/search.png') }}"
                             alt=""></a>
                     <a href="#"><img src="{{ asset('front/img/icon/heart.png') }}" alt=""></a>
                     <a href="{{ url('shopping-cart') }}"><img src="{{ asset('front/img/icon/cart.png') }}"
                             alt="">
                         <span>0</span></a>
                     <div class="price">$0.00</div>
                 </div>
