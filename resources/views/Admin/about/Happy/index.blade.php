    ...
    <div class="col-md-12">
        <div class="tile">
            <div class="tile-title-w-btn">
                ...
                <p> <a class="btn btn-primary icon-btn" href="{{ route('happy.create') }}">
                            ...
                            <tbody>
                                ...
                                @foreach ($happy as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <form action="{{ route('happy.destroy', $item->id) }}" method="POST">

                                                <a class="btn btn-info btn-ms"
                                                    href="{{ route('happy.show', $item->id) }}">
                                                    </i> Show</a>
                                                <a class="btn btn-success btn-ms"
                                                    href="{{ route('happy.edit', $item->id) }}"> Edit</a>
