    ...
    <div class="col-md-12">
        <div class="tile">
            <div class="tile-title-w-btn">
                ...
                <h3 class="title">Partner Detail</h3>
                ...
                <p> <a class="btn btn-primary icon-btn" href="{{ route('partner.create') }}">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <img style="height: 80px"
                                                src="{{ asset('storage/about/partner/' . $item->image) }}">
                                        </td>
                                        ...
                                        <td>
                                            <form action="{{ route('partner.destroy', $item->id) }}" method="POST">
                                                ...
                                                <a class="btn btn-info btn-ms" href="{{ route('partner.show', $item->id) }}">
                                                    </i> Show</a>
                                                <a class="btn btn-success btn-ms"
                                                    href="{{ route('partner.edit', $item->id) }}"> Edit</a>
