    ...
    <div class="col-md-12">
        <div class="tile">
            <div class="tile-title-w-btn">
                ...
                <h3 class="title">Slider Detail</h3>
                ...
                <p> <a class="btn btn-primary icon-btn" href="{{ route('slider.create') }}">
                            ...
                            <tbody>
                                ...
                                @foreach ($slider as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <img style="height: 80px" src="{{ asset('storage/slider/' . $item->image) }}">
                                        </td>
                                        ...
                                        <td>
                                            <form action="{{ route('slider.destroy', $item->id) }}" method="POST">
                                                ...
                                                <a class="btn btn-info btn-ms"
                                                    href="{{ route('slider.show', $item->id) }}"> </i> Show</a>
