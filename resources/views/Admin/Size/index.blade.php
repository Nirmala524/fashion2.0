    ...
    <div class="col-md-12">
        <div class="tile">
            <div class="tile-title-w-btn">
                ...
                <p> <a class="btn btn-primary icon-btn" href="{{ route('size.create') }}">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form action="{{ route('size.destroy', $item->id) }}" method="POST">
                                                <a class="btn btn-info btn-ms" href="{{ route('size.show', $item->id) }}">
                                                    </i> Show</a>
                                                <a class="btn btn-success btn-ms"
                                                    href="{{ route('size.edit', $item->id) }}"> Edit</a>
                                                    @csrf
                                                    @method('DELETE')
