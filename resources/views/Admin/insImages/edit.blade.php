...
@section('content')
    <div class="col-md-12">
        <div class="tile">
            <h3 class="tile-title">Edit Instagram</h3>

            <div class="tile-body">
                <form action="{{ route('InsImages.update', $img->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group">
                        ...
                        @enderror
                        <img style="height: 250px" src="{{ asset('storage/InstagramImg/' . $img->image) }}" alt="">
